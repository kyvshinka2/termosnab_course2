...
<head>
    ...
    <title>Термоснаб - Сварочное оборудование</title>
    <!-- иконка -->
...
<body>
    ...
    <div class="content">
        <div class="bottomInfoHead">
            <p>Вы здесь: => <a href="../inedx.php">Главная страница</a> => <a href="./katalog.php">Каталог</a> => Сварочное оборудование </p>
        ...
        <?php
            ...
            $sql = "SELECT `Name`, `Description`, `Price`, `Img`, `Quantity` FROM `Product` WHERE `Category` = 'Сварочное оборудование'";
