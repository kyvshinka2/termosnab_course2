...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 01 2023 г., 21:56
...
--
-- Дамп данных таблицы `OrderBuy`
--

INSERT INTO `OrderBuy` (`ID`, `ID_Product`, `ID_Delivery`, `ID_User`, `Comment`) VALUES
(12, 7, 1, 2, 'нет');
...
(1, 'Александр', 'sasha123', '$2y$10$bIb0c1avuTFDZjIlymBNSueN7mgWwHSjKXHEPbFi0/9UHNKZmBOL6', '', 0, '', 0),
(2, 'Лена', 'lena123', '$2y$10$fkHjxY2gdKPNPe.YtOPmOOgTO36MdV7iQIkSMm0j.SFjuO/965YWC', '', 0, '', 0);
...
--
-- AUTO_INCREMENT для таблицы `OrderBuy`
--
ALTER TABLE `OrderBuy`
...
--
-- Ограничения внешнего ключа таблицы `OrderBuy`
--
ALTER TABLE `OrderBuy`
  ADD CONSTRAINT `orderbuy_ibfk_2` FOREIGN KEY (`ID_Delivery`) REFERENCES `Delivery` (`ID`),
  ADD CONSTRAINT `orderbuy_ibfk_3` FOREIGN KEY (`ID_Product`) REFERENCES `Product` (`ID`),
  ADD CONSTRAINT `orderbuy_ibfk_4` FOREIGN KEY (`ID_User`) REFERENCES `User` (`ID`);
